  ...
  const cards = [
    {
      ...
      icon: commission,
      title: t("Commission"),
      content: t("Offer partners a percentage of the trading commissions generated by their referred clients This model aligns their success with your revenue, incentivizing them to drive more trading activity")
    },
    {
      id: 2,
      icon: Rewards,
      title: t("Lot-Based Rewards"),
      content: t("Fixed rewards for each lot traded by clients in the forex market")
    },
    {
      id: 3,
      icon: MultipleCurrencies,
      title: t("Multiple Currencies"),
      content: t("Offer rewards in any cryptocurrency or fiat currency for maximum flexibility")
    },
    {
      id: 4,
      icon: CustomizableFrequency,
      title: t("Customizable Frequency"),
      content: t("Enable partners to choose when they get paid—hourly, daily, weekly, or monthly—offering convenience and catering to their cash flow needs This adaptability keeps them engaged and motivated")
    }
  ];
  ...
  return (
    <div className={style.ib_Full_container}>
      ...
      <div className={`${style.custom_Grid}`}>
        ...
        <div className="container">
        <Heading
          title={t("Flexible Rewards")}
          subTitle={t("Program for Partners")}
        />
        ...
        <div className={style.features}>
          <div className="container">
            {/* heading */}
        <Heading
          title={t("Key Features of FINITIC’s IB Portal")}
          subTitle={t("Powerful Tools to optimize your partners performance and maximize growth")}
        />
        {/* feature box */}
