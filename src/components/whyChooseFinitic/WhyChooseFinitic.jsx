...
import { useWhyChooseFinitic } from '@/data/whyChooseFinitic'
...
const WhyChooseFinitic = () => {
  ...
  const whyChooseFinitic = useWhyChooseFinitic();
  ...
  return (
    <section className={`container ${styles["choose-finitic__container"]}`}>
     <ProductHeader  productName={" PAMM/MAM"} startDescription={t("Why Choose FINITIC")} />
      ...
      {whyChooseFinitic.map((feature, index) => (
        <div data-aos="fade-up" data-aos-duration={500 + index * 500} key={index} className={styles.card}>
          <div className={styles.content}>
            <Flex direction="row" gap="10px" align="center" justify="start">
